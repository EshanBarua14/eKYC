...
def create(req: CreateFallbackRequest):
    """
...
def upload_document(case_id: str, req: DocumentUploadRequest):
...
def review_start(case_id: str, req: ReviewStartRequest):
...
def review_decide(case_id: str, req: ReviewDecideRequest):
